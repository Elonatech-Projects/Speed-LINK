  ...
  return (
    <div className="bg-[#e6e8ef]   ">
      <div className=" py-25 2xl:mx-71 xl:px-15 px-5">
        <div className="container flex md:flex-row flex-col items-end 2xl:justify-between gap-13">
          ...
          <div className="2xl:w-180 w-full space-y-5">
            <div className="flex items-start md:justify-between">
              ...
              <p className="border rounded-full text-[#4d4d4d]  px-2.5 py-1.25 font-semibold text-[12px] md:text-[16px] whitespace-nowrap ">
                ESTD 2014
              </p>
            </div>
          ...
          <div className="md:hidden block bg-linear-to-b from-[#ed3539] to-[#b42225] px-8 pt-8 pb-6 rounded-tr-[40px] rounded-bl-[40px] space-y-5 w-full">
            <p className="text-[14px] text-white ">
              SPEEDLINK HI-TECH SOLUTIONS
            </p>
