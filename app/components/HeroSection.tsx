  ...
  return (
    <div className="hero ">
      <div className="  2xl:mx-auto w-full px-5 ">
        <div className="container flex flex-col items-center xl:pt-40 md:pt-20 pt-10 justify-center text-center ">
          <div className="flex items-center justify-between md:justify-center md:gap-8 gap-4 xl:gap-3.5 mb-6 border rounded-full p-1.5  md:w-91 w-85  text-[14px] xl:text-[16px]">
            ...
            <button className="bg-[#aeb8fe] py-1.75 px-3 text-[12px] xl:text-[14px] rounded-full text-[#404297] hover:text-[#ffffff] hover:bg-[#ec4145] whitespace-nowrap">
              Learn More
            </button>
          </div>
